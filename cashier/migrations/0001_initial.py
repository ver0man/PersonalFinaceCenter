# -*- coding: utf-8 -*-
# Generated by Django 1.9.1 on 2016-01-31 19:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('wallet_time', models.DateTimeField(auto_now_add=True)),
                ('wallet_person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
